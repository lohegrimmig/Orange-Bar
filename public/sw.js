...
const CACHE = 'orange-bar-v5';
const SHELL = [
  '/', '/index.html', '/style.css', '/app.js', '/webauthn-client.js', '/i18n.js',
  '/prf.js', '/iota-sign.js', '/vendor/qrcode.js', '/vendor/blake2b.js',
  '/vendor/noble-ed25519.js', '/manifest.webmanifest', '/icons/icon.svg',
];
