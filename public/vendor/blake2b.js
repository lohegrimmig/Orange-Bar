// BLAKE2b in pure JavaScript – self-contained ESM port.
// Adapted from the reference implementation in RFC 7693, ported to JavaScript
// by DC (https://github.com/dcposch, blakejs, MIT). Only the parts Orange-Bar
// needs (unkeyed hashing of a byte array) are kept; the util dependency is
// inlined and CommonJS exports are replaced with ESM exports.
...
/** BLAKE2b of a Uint8Array. outlen in bytes (default 64). No key/salt. */
export function blake2b(input, outlen = 64) {
  if (!(input instanceof Uint8Array)) throw new Error('blake2b: input must be a Uint8Array');
