...
**Status:** Phase 1–4 implementiert (Propose, Policies/PWA, Agent-Station, Facilitator).  
...
### Phase 4 — Facilitator (Zahlungsempfänger-Seite) ✅
...
| Facilitator (Phase 4, verify-only, kein Pool/Escrow) | Kein Transfer-Service i. S. v. Art. 3(1)(26) MiCAR — bewegt selbst nichts. Kein Präzedenzfall; vor Produktivbetrieb rechtlich prüfen. Details: `docs/FACILITATOR.md` |
...
| `docs/FACILITATOR.md` | Phase 4: Facilitator-Architektur (Zahlungsempfänger-Seite) |
| `server/facilitator.js` / `server/paywall.js` / `server/routes/facilitator.js` | Phase 4: Verify/Settle, Merchant-Middleware, REST |
| `tests/facilitator.test.js` | Phase 4: Unit-Tests |
